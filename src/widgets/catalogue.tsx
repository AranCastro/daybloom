...
export const WIDGETS: readonly WidgetSpec[] = [
  { name: 'Matrix', title: 'Eisenhower Matrix', blurb: 'All four quadrants and their tasks. Tap a task to tick it off; Undo puts it back, and the lock stops accidental taps.', width: 320, height: 330, cells: '4 × 3', render: MatrixWidget, custom: 'Matrix' },
  ...
  { name: 'Tasks', title: 'Focus today', blurb: 'Your most important tasks. Tap a task to tick it off; Undo puts it back, and the lock stops accidental taps.', width: 320, height: 176, cells: '4 × 2', render: TasksWidget },
